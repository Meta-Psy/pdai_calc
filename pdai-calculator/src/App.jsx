...
import { CalculatorIcon, Printer, Download, Loader, RefreshCw, Undo } from './components/icons';
          ...
          <header className="bg-white rounded-xl shadow-lg p-4 md:p-6 mb-6">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="hidden sm:flex items-center gap-1.5 no-print">
                ...
                {/* Utility group */}
                <div className="flex gap-1">
                  <button onClick={calc.undo} disabled={!calc.canUndo} className="flex items-center gap-1.5 px-2.5 py-2 hover:bg-gray-100 disabled:opacity-30 text-gray-600 rounded-lg transition-colors text-sm" title={t('actions.undo') + ' (Ctrl+Z)'}>
                    <Undo /><span className="hidden lg:inline">{t('actions.undo')}</span>
                  </button>
